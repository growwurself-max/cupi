...
export const defaultSpecialHeartBloomConfig: ExperienceConfig = {
  ...
  content: {
    ...
    wishPrompt: 'watch it bloom',
    finalMessage: 'Happy Birthday to someone worth celebrating',
    finalCelebration: 'Happy Birthday to a year that blooms',
    photos: [],
  },
  branding: {
    accentColor: '#ff5c8a',
