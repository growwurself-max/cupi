...
export function Screen4_5Bouquet({
  ...
  return (
    <ScreenShell>
      ...
      <div
        aria-hidden
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(circle_at_50%_28%,rgba(251,113,133,0.22),rgba(244,114,182,0.14)_48%,transparent_72%)]"
      />
      ...
      >
        ...
        <h1 className="font-serif mt-2 text-balance text-3xl font-bold italic text-[#881337] sm:text-4xl">
          {title}
        </h1>
        <p className="mx-auto mt-2 max-w-sm text-pretty text-sm text-rose-950/70">
          {subtitle}
        </p>
      </motion.div>
      ...
      <div className="relative z-10 h-[24rem] w-full max-w-md sm:h-[27rem]">
        ...
        <motion.div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(251,113,133,0.35) 0%, rgba(244,114,182,0.22) 45%, transparent 70%)',
          }}
        />
        ...
        {notes.slice(0, TAG_POSITIONS.length).map((note, i) => {
          ...
          return (
            <motion.button
              ...
              className={`absolute z-30 flex max-w-[150px] items-start gap-2 rounded-2xl px-3.5 py-2.5 text-left text-[11px] font-semibold leading-snug border shadow-md transition-colors duration-300 outline-none sm:max-w-[168px] sm:text-[13px] ${
                isActive
                  ? 'border-2 border-rose-400/80 bg-rose-100/90 text-rose-900 shadow-[0_0_24px_-4px_rgba(244,114,182,0.6)]'
                  : 'border border-rose-200 bg-white/90 text-rose-900 hover:border-rose-300'
              }`}
            >
              {note.emoji && (
                <span
        ...
        >
          ...
          >
            ...
            <div className="relative flex items-end gap-1.5">
              {['🌷', '🌹'].map((rose, i) => (
                <motion.span
                  ...
                  className="text-3xl drop-shadow-[0_6px_10px_rgba(244,114,182,0.35)]"
                  aria-hidden
                >
                  {rose}
                </motion.span>
              ))}
              <span className="z-10 -mx-1 text-5xl drop-shadow-[0_8px_14px_rgba(244,114,182,0.4)]">
                💐
              </span>
              <motion.span
            ...
            />
            <span
              className="-mt-3 text-xl drop-shadow-[0_4px_8px_rgba(244,114,182,0.35)]"
              aria-hidden
            >
              🎀
            </span>
      ...
      <motion.p
        ...
        animate={{ opacity: 1 }}
        transition={{ delay: 1 }}
        className="relative z-20 mt-3 text-xs font-semibold tracking-wide text-rose-700/70 uppercase"
      >
      ...
      >
        <motion.button
          ...
          animate={{
            boxShadow: [
              '0 0 22px -4px rgba(244,114,182,0.45)',
              '0 0 42px -4px rgba(244,114,182,0.8)',
              '0 0 22px -4px rgba(244,114,182,0.45)',
            ],
          }}
